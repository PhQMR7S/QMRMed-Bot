...
bot.command('terms', async ctx => ctx.reply('📜 شروط الاستخدام\n\nاستخدام QMRMed تعليمي فقط. المحتوى لا يُعد تشخيصًا أو استشارة طبية شخصية.\n\nقبل شراء اشتراك مدفوع، يجب قراءة الشروط والموافقة عليها.', { reply_markup: new InlineKeyboard().text('💙 أوافق وأريد PLUS', 'terms:accept:PLUS').row().text('💜 أوافق وأريد PRO', 'terms:accept:PRO').row().text('⬅️ الرئيسية', 'home') }));
